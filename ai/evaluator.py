...
def evaluate_answer(player_name: str, challenge: str, player_answer: str, cefr: str = "B2") -> dict:
    ...
    prompt = evaluator_prompt(player_name, challenge, player_answer, srs, cefr)
    ...
    try:
        ...
        return {"correct": False, "explanation": "Could not evaluate answer. Please try again.", "grammar_focus": ""}
    except Exception as e:
        return {"correct": False, "explanation": f"API error: {str(e)}", "grammar_focus": ""}
